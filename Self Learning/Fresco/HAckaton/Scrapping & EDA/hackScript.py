...
def draw_barplot_top10_cryptocurrencies_with_highest_market_value(cryptocur_df):
    ...
    '''
    bPVals = pd.DataFrame(cryptocur_df.sort_values('market_cap', ascending=False).head(10))
    #ax = sns.barplot(data=bPVals, x='market_cap')
    ax = sns.factorplot("market_cap", data=bPVals,kind="bar");    
    return ax
    '''
    barPlotVals = cryptocur_df.sort_values('market_cap', ascending=False).head(10)
    #ax = sns.barplot(data=barPlotVals, x='market_cap', y='currency_name',orient='h')
...
def draw_scatterplot_trend_of_price_with_market_value(cryptocur_df):
    ...
    scatterPlotVals = cryptocur_df.sort_values('market_cap', ascending=False).head(50)
...
def draw_barplot_top10_cryptocurrencies_with_highest_positive_change(cryptocur_df):
    ...
    #ax2 = sns.barplot(data=cryptocur_df.sort_values('change', ascending=False).head(10), 
                      #x='change', y='currency_name')
    #return ax2
